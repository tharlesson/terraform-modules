...
aws_assume_role_session_name = "terraform-bootstrap-iam-client-a-stg"
...
workload_roles = {
  ...
  app-runtime = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-stg-ecs-tasks"
    ]
    managed_policy_arns = [
  ...
  batch-jobs = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-stg-batch-service"
    ]
    managed_policy_arns = [
  ...
  ci-cd = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-stg-ci-runner"
    ]
    managed_policy_arns = [
