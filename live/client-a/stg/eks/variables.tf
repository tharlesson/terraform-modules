...
variable "workload_name" {
  description = "Workload suffix used in EKS naming."
  type        = string
  default     = "platform"
}
...
variable "cluster_version" {
  description = "Optional Kubernetes version for EKS cluster."
  type        = string
  default     = null
}
...
variable "oidc_thumbprint_list" {
  description = "Optional thumbprint list for IAM OIDC provider."
  type        = list(string)
  default     = null
}
