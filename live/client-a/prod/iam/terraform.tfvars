...
aws_assume_role_session_name = "terraform-bootstrap-iam-client-a-prod"
...
workload_roles = {
  ...
  app-runtime = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-prod-ecs-tasks"
    ]
    managed_policy_arns = [
  ...
  batch-jobs = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-prod-batch-service"
    ]
    managed_policy_arns = [
  ...
  ci-cd = {
    ...
    trusted_principal_arns = [
      "arn:aws:iam::111122223333:role/client-a-prod-ci-runner"
    ]
    managed_policy_arns = [
