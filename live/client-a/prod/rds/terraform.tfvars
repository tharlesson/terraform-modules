...
aws_assume_role_session_name = "terraform-rds-client-a-prod"
...
allowed_cidr_blocks        = ["10.52.10.0/24", "10.52.11.0/24", "10.52.12.0/24"]
...
final_snapshot_identifier = "client-a-prod-app-db-final"
